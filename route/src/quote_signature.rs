...
mod tests {
    ...
    fn verifies_official_sdk_fixture() {
        ...
        assert_eq!(
            q.quote_request.app_fees.as_ref().unwrap()[0]
                .limit_order_id
                .as_deref(),
            Some("order_01JQ7YJ9Q5")
        );
